...
pack_dict = {
    ...
    "ANN_model.h5": ["tf.keras.models.Sequential", "tf.keras.models.Sequential"]
}
...
model = "/home/eamicheal/tvmTE0802/vta/tutorials/codefiles/zhangtvmrun/ANN-model.h5"
...
if env.TARGET not in ["sim", "tsim", "intelfocl"]:
    ...
    vta.program_fpga(remote, bitstream="/home/eamicheal/tvmTE0802/vta/tutorials/vta.bit")
...
with autotvm.tophub.context(target):
    ...
    gluon_model = vision.get_model(model, pretrained=False)

    # Measure build start time
    build_start = time.time()

    # Start front end compilation
    mod, params = relay.frontend.from_keras(gluon_model, shape_dict)
...
file = '/home/eamicheal/tvmTE0802/vta/tutorials/codefiles/zhangtvmrun/oneperson.xlsx'
